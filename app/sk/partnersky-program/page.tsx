...
import { contact, partner } from '@/lib/content';

export const metadata: Metadata = {
  title: 'Partnerský program ★ Rewora',
  description:
    'Pre agentúry, freelancerov a konzultantov: odporučte Reworu svojim klientom a poberajte opakovanú províziu. Demo účet, podklady a prednostná podpora.',
  alternates: { canonical: '/sk/partnersky-program/' },
};

export default function PartnerskyProgramPage() {
        ...
        <div className="container partner__contact">
          ...
          <div>
            ...
            <div className="partner__contact-actions">
              <a className="btn btn--orange" href={`mailto:${person.email}?subject=Partnersk%C3%BD%20program`}>
                {partner.cta.button}
              </a>
